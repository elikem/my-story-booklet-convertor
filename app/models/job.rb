...
class Job < ActiveRecord::Base
  ...
  def get_published_jobs_from_api
    ...
    get_published_stories = HTTParty.get('http://my-story-booklet.herokuapp.com/api/published_stories')
  ...
  def story_for_idml(username)
    HTTParty.get("http://my-story-booklet.herokuapp.com/api/stories/#{username}/idml")
  end
